...
def menu_scene():
    # this function is the menu screen
...
def game_scene():
    ...
    neopixels = neopixel.NeoPixel(board.NEOPIXEL, constants.NEOPIXEL_COUNT,
                                  brightness=constants.NEOPIXEL_BRIGHTNESS,
    ...
    while True:
        ...
        if a_button == constants.button_state["button_just_pressed"]:
            ...
            #     if have not used up all the lasers
            for laser_number in range(len(lasers)):
                for counter in range(constants.NEOPIXEL_COUNT):
                    neopixels[counter] = (0, 10, 0)
                for counter in range(laser_number + 1):
                    neopixels[counter] = (10, 10, 0)
                if laser_number == 4:
                    for counter in range(constants.NEOPIXEL_COUNT):
                        neopixels[counter] = (10, 0, 0)
